function initMap(){
  ...
  var restaurants = [
        ...
        ['Oberoi\'s Indian Food', 41.838076, -87.633827,'<h1 style="font-size: 22px">Oberoi\'s Indian Food</h1><p style="font-size: 15px">A very conveniently located Indian restaurant around the IIT campus<br> Recommendation: Mango Lassi</p>'],
        ['Vivere',41.880585, -87.630197,'<h1 style="font-size: 22px">Vivere</h1><p style="font-size: 15px">A very fancy Italian restaurant downtown.<br> Recommendation: Ravioli di Formaggi con Pomodoro</p>'],
        ['Magnolia Cafe', 41.883962, -87.628129,'<h1 style="font-size: 22px">Magnolia Cafe</h1><p style="font-size: 15px">A popular coffee shop and bakery. Located on heart of Downtown<br> Recommendation: Caramel Latte</p>']]; 
